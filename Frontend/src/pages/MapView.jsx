...
function computePotholePenalty(route, snappedPotholes, criticality) {
  const SNAP_RADIUS = 25;   // metres – pothole must be this close to any waypoint
  const BASE        = 15;   // seconds per severity-weight unit
...
function MapView() {
  ...
  const [potholes,           setPotholes]            = useState([]);       // raw server data
  const [snappedPotholes,    setSnappedPotholes]     = useState([]);       // snapped for map + ETA
  const [useDummyPotholes,   setUseDummyPotholes]    = useState(false);    // demo toggle
  ...
  const routeAsterMedcity = [
    ...
    [9.996051,76.300481],[9.996051,76.300481],[9.996117,76.300335],
    [9.996162,76.300264],[9.996207,76.300202],[9.996271,76.300136],
    [9.996338,76.300073],[9.996416,76.300022],[9.996491,76.299975],
    [9.996567,76.299922],[9.996648,76.299893],[9.996732,76.299852],
    [9.996811,76.299814],[9.996901,76.299786],[9.996985,76.299753],
    [9.997069,76.299727],[9.997154,76.299698],[9.997244,76.299682],
    [9.997333,76.299668],[9.997428,76.299667],[9.997514,76.299677],
    [9.997559,76.299682],[9.997601,76.299693],[9.997648,76.299703],
    [9.997689,76.299712],[9.997734,76.299731],[9.997778,76.299739],
    [9.997821,76.299757],[9.997860,76.299770],[9.997898,76.299801],
    [9.997941,76.299819],[9.997986,76.299846],[9.998019,76.299863],
    [9.998054,76.299888],[9.998084,76.299917],[9.998124,76.299949],
    [9.998159,76.299972],[9.998188,76.300013],[9.998217,76.300046],
    [9.998249,76.300074],[9.998271,76.300115],[9.998278,76.300109],
    [9.998298,76.300122],[9.998313,76.300121],[9.998363,76.300124],
    [9.998411,76.300135],[9.998498,76.300153],[9.998591,76.300169],
    [9.998676,76.300183],[9.998769,76.300196],[9.998845,76.300217],
    [9.998864,76.300223],[9.998900,76.300218],[9.998927,76.300211],
    [9.998946,76.300210],[9.999035,76.300181],[9.999120,76.300149],
    [9.999202,76.300124],[9.999298,76.300092],[9.999370,76.300072],
    [9.999464,76.300034],[9.999464,76.300034],[9.999667,76.299967],
    [9.999719,76.299944],[9.999796,76.299918],[9.999886,76.299890],
    [9.999970,76.299856],[10.000049,76.299828],[10.000143,76.299803],
    [10.000237,76.299781],[10.000318,76.299737],[10.000388,76.299685],
    [10.000474,76.299617],[10.000463,76.299557],[10.000483,76.299525],
    [10.000502,76.299479],[10.000481,76.299412],[10.000484,76.299384],
    [10.000425,76.299296],[10.000201,76.298929],[9.999930,76.298575],
    [9.999858,76.298414],[9.999899,76.298385],[9.999959,76.298363],
    [9.999987,76.298359],[10.000031,76.298424],[10.000239,76.298735],
    [10.000363,76.298886],[10.000476,76.299081],[10.000696,76.299459],
    [10.000912,76.299868],[10.001101,76.300278],[10.001245,76.300765],
    [10.001301,76.301163],[10.001392,76.301607],[10.001455,76.302057],
    [10.001560,76.302525],[10.001680,76.302950],[10.001876,76.303393],
    [10.002144,76.303738],[10.002471,76.304044],[10.002828,76.304327],
    [10.003217,76.304570],[10.003633,76.304765],[10.004053,76.304921],
    [10.004460,76.305024],[10.004897,76.305077],[10.005178,76.305078],
    [10.005273,76.305062],[10.005600,76.304994],[10.005832,76.304922],
    [10.005996,76.304826],[10.006110,76.304788],[10.006433,76.304681],
    [10.006873,76.304538],[10.007297,76.304416],[10.007733,76.304282],
    [10.007952,76.304219],[10.007960,76.304204],[10.007900,76.303992],
    [10.007786,76.303585],[10.007789,76.303560],[10.007808,76.303558],
    [10.007832,76.303518],[10.007858,76.303480],[10.007858,76.303458],
    [10.007874,76.303414],
  ];
  ...
  const routeRennai = [
    ...
    [10.000474,76.299617],[10.000463,76.299557],[10.000483,76.299525],
    [10.000502,76.299479],[10.000481,76.299412],[10.000484,76.299384],
    [10.000425,76.299296],[9.999999,76.298640],[9.999942,76.298569],
    [9.999890,76.298492],[9.999840,76.298418],[9.999800,76.298350],
    [9.999752,76.298277],[9.999709,76.298195],[9.999653,76.298121],
    [9.999604,76.298046],[9.999553,76.297969],[9.999494,76.297899],
    [9.999440,76.297826],[9.999388,76.297754],[9.999338,76.297684],
    [9.999308,76.297643],[9.999050,76.297395],[9.998701,76.296933],
    [9.998461,76.296715],[9.998151,76.296272],[9.997899,76.295942],
    [9.997535,76.295483],[9.997184,76.295091],[9.996841,76.294657],
    [9.996584,76.294248],[9.996214,76.293760],[9.995830,76.293217],
    [9.995488,76.292784],[9.995261,76.292505],[9.994999,76.292152],
    [9.994522,76.291710],[9.994255,76.291447],[9.993959,76.291144],
    [9.993594,76.290828],[9.993282,76.290505],[9.992954,76.290205],
    [9.992637,76.289848],[9.992308,76.289544],[9.991996,76.289173],
    [9.991709,76.288791],[9.991365,76.288431],[9.991089,76.288091],
    [9.990843,76.287778],[9.990505,76.287428],[9.990138,76.287158],
    [9.989808,76.286920],[9.989458,76.286691],[9.989130,76.286491],
    [9.988678,76.286236],[9.988290,76.285981],[9.987926,76.285686],
    [9.987529,76.285359],[9.987529,76.285359],[9.986929,76.284685],
    ...
    [9.996163,76.277949],[9.996988,76.278173],[9.997423,76.278315],
    [9.997824,76.278397],[9.998405,76.278533],[9.998846,76.278716],
    [9.999296,76.278847],[9.999761,76.278955],[10.000191,76.279120],
    [10.000633,76.279218],[10.000994,76.279321],[10.001322,76.279389],
    [10.001338,76.279359],[10.001300,76.279171],[10.001191,76.278711],
    [10.001063,76.278249],[10.000984,76.277993],[10.001006,76.277979],
    [10.001144,76.277947],[10.001612,76.277843],[10.002012,76.277731],
    [10.002463,76.277627],[10.002917,76.277539],[10.003352,76.277412],
    [10.003809,76.277280],[10.004189,76.277041],[10.004346,76.276991],
    [10.004454,76.276947],[10.004612,76.276866],[10.005080,76.276736],
    [10.005331,76.276664],[10.005664,76.276563],[10.005687,76.276581],
    [10.005846,76.277028],[10.005975,76.277394],[10.006062,76.277609],
    [10.006291,76.278146],[10.006487,76.278222],[10.006650,76.278186],
    [10.006674,76.278093],[10.0066809,76.2774219],
  ];
  ...
  useEffect(() => {
    if (useDummyPotholes) {
      setPotholes(DUMMY_POTHOLES);
      setSnappedPotholes(DUMMY_POTHOLES); // already on waypoints – no snap needed
      return;
    }
    const fetchPotholes = async () => {
      try {
        ...
        setPotholes(data);
        const snapped = data.map(p => {
          const { lat, lng } = snapToNearestRoutePoint(
            parseFloat(p.lat), parseFloat(p.lng), hospitalRoutes
          );
          return { ...p, lat, lng };
        });
        setSnappedPotholes(snapped);
      } catch (err) {
  ...
  useEffect(() => {
    ...
    const broadcast = async () => {
      ...
      const sigDists      = signals.map(s => ({ id: s.id, d: distMeters(currentPosition[0], currentPosition[1], s.position[0], s.position[1]) }));
      const nearbySignals = sigDists.filter(s => s.d < thr && s.d > 10).map(s => s.id);
  ...
  useEffect(() => {
    ...
    const check = async () => {
      try {
        ...
        if (d.shouldBeep) {
          if (!beepIntervalRef.current) { triggerBeep(); beepIntervalRef.current = setInterval(triggerBeep, 500); }
        } else {
  ...
  useEffect(() => {
    ...
    const iv = setInterval(() => {
      ...
      if (np >= 1) {
        ...
        lat = lat1 + (lat2 - lat1) * np;
        lng = lng1 + (lng2 - lng1) * np;
        setProgress(np);
      }
      ...
      setSignals(prev => prev.map(s => ({
        ...s,
        state: distMeters(lat, lng, s.position[0], s.position[1]) <= getThresholdDistance() ? "GREEN" : "RED",
      })));

      setCars(prev => prev.map(c => {
        if (distMeters(lat, lng, c.position[0], c.position[1]) < 80 && !c.movedAside)
          return { ...c, position: [c.position[0] - 0.00008, c.position[1] + 0.00008], movedAside: true };
        return c;
      }));
  ...
  const ETAseconds = () => Math.max(0, Math.round(
    getDistance() / AMBULANCE_SPEED +
    signals.filter(s => distMeters(currentPosition[0], currentPosition[1], s.position[0], s.position[1]) <= getDistance() && s.state === "RED").length * geDelayTime() +
    etaBias[getTimeBucket()]
  ));
  ...
  const computeETAForRoute = (testRoute, bias = etaBias) => {
    ...
    for (let i = 0; i < testRoute.length - 1; i++)
      dist += distMeters(testRoute[i][0], testRoute[i][1], testRoute[i + 1][0], testRoute[i + 1][1]);

    const penalty = computePotholePenalty(testRoute, snappedPotholes, criticality);
    return Math.round(dist / AMBULANCE_SPEED + signals.filter(s => s.state === "RED").length * geDelayTime() + penalty + bias[getTimeBucket()]);
  };
  ...
  const autoSelectNearestHospital = () => {
    ...
    const etaList = hospitalRoutes.map(h => ({
      ...
      penalty: computePotholePenalty(h.route, snappedPotholes, criticality),
    }));
  ...
  const triggerVibration = () => { if ("vibrate" in navigator) navigator.vibrate([200, 100, 200]); };
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{
        ...
        maxHeight: "92vh", overflowY: "auto", minWidth: "210px",
      }}>

        <div style={{ background: isMaster ? "#4caf50" : "#ff9800", color: "white", padding: "8px", borderRadius: "4px", fontWeight: "bold", textAlign: "center" }}>
        ...
        {isMaster && (<>
          ...
          {/* Hospital ETA comparison */}
          {hospitalETAs.length > 0 && (
            <div style={{ fontSize: "12px" }}>
              <b>Hospital comparison:</b>
              {hospitalETAs.map(h => (
                <div key={h.id} style={{
                  marginTop: "4px", padding: "5px 7px", borderRadius: "5px",
                  background: selectedHospital?.id === h.id ? "#e8f5e9" : "#f9f9f9",
                  border: `1px solid ${selectedHospital?.id === h.id ? "#4caf50" : "#ddd"}`,
                }}>
                  <div style={{ fontWeight: "bold", color: selectedHospital?.id === h.id ? "#1b5e20" : "#222", fontSize: "11px" }}>
                    {selectedHospital?.id === h.id ? "✅ " : "   "}{h.name}
                  </div>
                  <div style={{ fontSize: "11px", color: "#444" }}>{formETA(h.eta)}</div>
                  {h.penalty > 0 && (
                    <div style={{ fontSize: "10px", color: "#b71c1c", marginTop: "1px" }}>
                      🕳️ +{h.penalty}s pothole penalty
                    </div>
                  )}
                </div>
              ))}
          ...
          <button style={{ background: "#1976d2", color: "white", fontWeight: "bold" }}
            onClick={autoSelectNearestHospital}>
            🏥 AUTO SELECT NEAREST
          </button>

          <button style={{ background: "#555", color: "white" }} onClick={resetLearning}>
            RESET LEARNING
          </button>
          <div style={{
            marginTop: "6px", border: "2px solid #e65100",
            borderRadius: "6px", padding: "8px", background: "#fff3e0",
          }}>
            <div style={{ fontSize: "11px", fontWeight: "bold", color: "#bf360c", marginBottom: "4px" }}>
              🧪 DEMO: POTHOLE REROUTING
            </div>
            ...
            <button
              onClick={() => { setUseDummyPotholes(p => !p); setHospitalETAs([]); }}
              style={{
                width: "100%", padding: "8px 4px", borderRadius: "5px", border: "none",
                fontWeight: "bold", fontSize: "12px", cursor: "pointer",
                background: useDummyPotholes ? "#212121" : "#e65100",
                color: "white",
            ...
            {useDummyPotholes && (
              <div style={{ marginTop: "6px", fontSize: "10px", lineHeight: "1.6", background: "#fbe9e7", padding: "5px", borderRadius: "4px" }}>
                <b>Active (6 potholes):</b><br />
                <span style={{ color: "#b71c1c" }}>Lisie</span>: 2× severe + 1 moderate<br />
                <span style={{ color: "#e65100" }}>Aster</span>: 1× severe + 1 moderate<br />
                <span style={{ color: "#2e7d32" }}>Renai</span>: 1× mild ✅ wins!<br />
        ...
        <div style={{ fontSize: "10px", color: "#888", padding: "3px", background: "#f5f5f5", borderRadius: "3px" }}>
          ...
          <div style={{ borderTop: "1px solid #ddd", paddingTop: "6px" }}>
            ...
            {snappedPotholes.map((p, i) => (
              <div key={i} style={{
                ...
                marginTop: "3px", padding: "3px 6px", borderRadius: "3px",
                background: "#111", color: "white", fontSize: "10px",
              }}>
                <span>
                  <span style={{ display: "inline-block", width: 7, height: 7, borderRadius: "50%", background: getSeverityDotColor(p.severity), marginRight: 5 }} />
                  {p.severity}
                </span>
      ...
      <MapContainer center={center} zoom={15} style={{ height: "100vh", width: "100vw" }}>
        ...
        {corridorColor && route.length > 0 && (
          <Polyline positions={corridorPoints} pathOptions={{ color: corridorColor, weight: 6, opacity: 1 }} />
        )}
        ...
        {cars.map(c => (
          <Marker key={c.id} position={c.position} icon={carIcon}>
        ...
        {snappedPotholes.map((p, idx) => (
          <CircleMarker
            ...
            radius={10}
            pathOptions={{
              color: POTHOLE_BORDER, fill: true,
              fillColor: POTHOLE_FILL, fillOpacity: 0.9, weight: 2,
            }}
          >
            <Popup>
              <b>🕳️ Pothole</b><br />
