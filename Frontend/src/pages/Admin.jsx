    ...
    <div className="space-y-4">
      ...
      {active && (
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          {/* MapView in donor mode — passes from/to hospital IDs */}
...
export default function Admin() {
  // mode: "select" | "accident" | "donor" | "potholes" | "leaderboard"
  ...
  const navBtn = (label, target, color = "bg-blue-600") => (
    <button
      ...
      className={`${color} ${
        mode === target ? "ring-2 ring-offset-2 ring-blue-400" : ""
